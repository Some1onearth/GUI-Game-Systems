...
public class CustomisationSet : Stats
{
    ...
    void ChooseClass(int classIndex)
    {
        switch (classIndex)
        {
            ...
            case 1:
                ...
                characterStats[3].value = 12;//int
                characterStats[4].value = 14;//wis
                characterStats[5].value = 15;//char
            ...
            case 3:
                ...
                break;
            case 4:
                characterStats[0].value = 14;//str
                characterStats[1].value = 14;//dex
                characterStats[2].value = 15;//con
            ...
            case 9:
                ...
                characterStats[3].value = 13;//int
                characterStats[4].value = 8;//wis
                characterStats[5].value = 14;//char
    ...
    void ChooseRace(int raceIndex)
    {
        ...
        switch (raceIndex)
        {
            case 0:
                ...
                characterStats[2].tempValue = 6;//con
    ...
    void SaveCharacter()
    {
        ...
        {
            PlayerPrefs.SetInt(characterStats[i].name, (characterStats[i].value + characterStats[i].tempValue + characterStats[i].levelTemptValue));
        }
    }
    #endregion
    #region OnGUI
